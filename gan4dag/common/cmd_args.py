...
cmd_opt.add_argument('-num_dag', type=int, default=512, help='number of DAGs')
...
cmd_opt.add_argument('-g_lr', type=float, default=1e-3, help='learning rate of generator')
...
cmd_opt.add_argument('-save_itr', type=int, default=250, help='how many iterations to save the trained states')
