...
"""
# 1. mlp
cmd_opt.add_argument('-mlp_hidden_dim', type=str, default='16-16-16')
...
# 3. threshold
cmd_opt.add_argument('-temperature', type=float, default=3.0)
...
cmd_opt.add_argument('-d_lr', type=float, default=1e-5, help='learning rate of decoder')
...
cmd_opt.add_argument('-gamma', type=float, default=0.25)
cmd_opt.add_argument('-ld', type=float, default=0.1)
cmd_opt.add_argument('-c', type=float, default=0.1)
cmd_opt.add_argument('-eta', type=float, default=5.0)
